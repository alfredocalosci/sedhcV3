<template>
  <div class="grid grid-cols-[300px_720px_1fr] ">
    ...
    <div class="bg-rosso-500 flex flex-col ">
       <aside class="py-6 px-8 aspect-square bg-scuro-900 text-white text-2xl hover:bg-gray-500 transition-colors duration-300 border-b border-white">

        <NuxtLink to="/" class="h-full w-full block">
           <img src="/img/sedhc_logo_ilustracion_inv.png" alt="sedhc" class="h-30 w-auto mt-2 mix-blend-screen bg-black">
      ...
      <section class="bg-rosso-500 text-white p-8 pl-8 ">
        <p>section</p>
      </section>
