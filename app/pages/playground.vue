<template>
  <div>
    ...
    <!-- 3 items -->
     <div class="container mx-auto mt-12 grid grid-cols-1 md:grid-cols-[1fr_1fr] gap-6 max-w-5xl">
      <div class="grid grid-cols-[1fr_2fr] p-2 ">
       <img src="/img/tratados_big/Serlio.jpg" alt="Example Image" class="w-full h-auto">
        <div class="p-4 border"><p>side</p></div>
      </div>

     <div class="grid grid-cols-[1fr_2fr] bg-chiaro-50">
       <img src="/img/tratados_big/T-003.jpg" alt="Example Image" class="w-full h-auto mix-blend-multiply ">
        <div class="p-4 border border-white"><p>side</p></div>
      </div>

      <div class="grid grid-cols-[1fr_3fr]  ">
       <img src="/img/tratados_big/T-003.jpg" alt="Example Image" class="w-full h-auto p-4 bg-white border border-gray-300 shadow-md">
        <div class="ml-12 hor_pattern"><p>side eee</p></div>
      </div>
