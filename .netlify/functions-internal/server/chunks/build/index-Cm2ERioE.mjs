    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_CustomUISidePanel, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="flex items-center justify-between pb-2 mb-8" data-v-b82c91d0${_scopeId}><img src="https://archive.org/download/ia-logo-white-transparent/ia-logo-white-transparent.png" alt="internet archive" class="max-w-1/2 lg:max-w-3/4 h-auto my-2" data-v-b82c91d0${_scopeId}></div><p class="font-semibold text-lg/6" data-v-b82c91d0${_scopeId}>${ssrInterpolate(unref(selectedTitle))}</p><div class="mt-8 mb-8 pointer-events-auto" data-v-b82c91d0${_scopeId}><a${ssrRenderAttr("href", "https://archive.org/details/" + unref(selectedItem))} target="_blank" class="flex items-center gap-x-2 mb-2 group" rel="noopener noreferrer" data-v-b82c91d0${_scopeId}>`);
            _push2(ssrRenderComponent(_component_UIcon, {
              name: "lucide:book-open",
              style: { "color": "white" },
              size: "24"
            }, null, _parent2, _scopeId));
            _push2(`<span class="ml-2 text-sm italic text-white/70 group-hover:text-white transition-colors duration-300" data-v-b82c91d0${_scopeId}>consultar en archive.org</span></a>`);
            if (unref(selectedPdfUrl)) {
              _push2(`<a${ssrRenderAttr("href", unref(selectedPdfUrl) ? unref(selectedPdfUrl) : "#")} target="_blank" class="flex items-center gap-x-2 group" rel="noopener noreferrer" data-v-b82c91d0${_scopeId}>`);
              _push2(ssrRenderComponent(_component_UIcon, {
                name: "lucide:hard-drive-download",
                style: { "color": "white" },
                size: "24"
              }, null, _parent2, _scopeId));
              _push2(`<span class="ml-2 text-sm italic text-white/70 group-hover:text-white transition-colors duration-300" data-v-b82c91d0${_scopeId}>descargar pdf</span></a>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div>`);
      ...
      _push(`<div class="sedhc_grid" data-v-b82c91d0><aside class="w-full h-full bg-neutro-500 flex flex-col" data-v-b82c91d0>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<img${ssrRenderAttr("src", _imports_0)} alt="sedhc" class="h-16 w-auto mt-2 mix-blend-screen bg-black" data-v-b82c91d0${_scopeId}><p class="text-sm/5 pt-2" data-v-b82c91d0${_scopeId}>Sociedad Española de Historia de la Construcción</p>`);
          } else {
            return [
              createVNode("img", {
                src: _imports_0,
      ...
      _push(`<article class="px-8 py-8" data-v-b82c91d0><div class="mb-10" data-v-b82c91d0>`);
      if (unref(sideText)) {
      ...
      _push(`</div><hr class="styled after:bg-neutro-500" data-v-b82c91d0><div class="mt-12" data-v-b82c91d0><!--[-->`);
      ssrRenderList(unref(topSubjects), (subject) => {
        _push(`<div data-v-b82c91d0><p class="flex justify-between pb-1 group text-gray-800 cursor-pointer" data-v-b82c91d0><strong class="${ssrRenderClass([unref(selectedSubject) === subject[0] || !unref(selectedSubject) ? "text-mist-800 font-semibold" : "  group-hover:text-gray-500 text-mist-500", "font-bold text-xs -ml-1 transition-colors duration-100"])}" data-v-b82c91d0>${ssrInterpolate(subject[0])}: </strong><span class="${ssrRenderClass([unref(selectedSubject) === subject[0] || !unref(selectedSubject) ? "text-mist-800" : "text-mist-500", "italic text-gray-600 text-xs"])}" data-v-b82c91d0>${ssrInterpolate(subject[1])}</span></p></div>`);
      });
      _push(`<!--]--></div></article></aside><div class="main_content bg-white" data-v-b82c91d0>`);
      _push(ssrRenderComponent(_component_GlobalHeaderAlt, null, null, _parent));
      _push(`<div class="mb-2 grid md:grid-cols-3 gap-2 md:gap-8 border-b border-dashed border-gray-400 py-6" data-v-b82c91d0>`);
      ...
      _push(`<div class="relative" data-v-b82c91d0><input type="search" id="site-search" name="q"${ssrRenderAttr("value", unref(searchString))} placeholder="Buscar …" class="font-mono text-xs border-b border-gray-400 focus:border-rosso-500 focus:ring-0 focus:outline-none transition-colors duration-200 w-full mb-0 md:mb-0 pl-6 pb-1.5" data-v-b82c91d0>`);
      ...
      _push(`</div></div><div class="flex flex-col md:flex-row md:items-center justify-between gap-y-2 md:gap-4 mb-16 z-5 md:sticky top-0 bg-white pb-3" data-v-b82c91d0><p class="font-mono text-xs text-gray-500 pt-2 md:pt-0" data-v-b82c91d0>mostrando publicaciones de <span class="text-scuro-900 font-semibold" data-v-b82c91d0>${ssrInterpolate((unref(currentPage) - 1) * maxOnPage + 1)}</span> a <span class="text-scuro-900 font-semibold" data-v-b82c91d0>${ssrInterpolate(Math.min(unref(currentPage) * maxOnPage, unref(filteredItems).length))}</span> de <span class="text-scuro-900 font-semibold" data-v-b82c91d0>${ssrInterpolate(unref(filteredItems).length)}</span></p><div class="font-mono" data-v-b82c91d0><ul class="inline-flex gap-1 text-xs" data-v-b82c91d0>`);
      if (unref(currentPage) > 1) {
        _push(`<li class="cursor-pointer px-1 py-1 rounded hover:bg-gray-200" data-v-b82c91d0>`);
        _push(ssrRenderComponent(_component_Icon, {
      ...
      ssrRenderList(unref(totalPages), (page) => {
        _push(`<li class="${ssrRenderClass([page === unref(currentPage) ? "text-black  font-bold" : "hover:bg-gray-200 font-normal text-gray-500", "cursor-pointer px-1 py-1"])}" data-v-b82c91d0>${ssrInterpolate(page)}</li>`);
      });
      _push(`<!--]-->`);
      ...
      if (unref(showAs) === "list") {
        _push(`<section class="mt-8" data-v-b82c91d0><!--[-->`);
        ssrRenderList(unref(pagedItems), (item) => {
          _push(`<div class="mb-6 pb-4 grid grid-cols-1 md:grid-cols-[1fr_4fr] gap-12 items-start cursor-pointer group" data-v-b82c91d0><div data-v-b82c91d0><img${ssrRenderAttr("src", `https://archive.org/services/img/${item.identifier}`)} alt="item.shortTitle" class="pt-6 group-hover:scale-105 transition-transform duration-300" data-v-b82c91d0></div><div data-v-b82c91d0><p class="text-sm italic text-gray-500" data-v-b82c91d0>${ssrInterpolate(item.year)} - ${ssrInterpolate(item.author)}</p><h2 class="${ssrRenderClass([unref(selectedItem) === item.identifier ? "text-rosso-500" : "", "text-xl/7 mb-2 mt-1 text-gray-900 font-semibold group-hover:text-rosso-500 transition-colors duration-300"])}" data-v-b82c91d0>${ssrInterpolate(item.shortTitle)}</h2><p class="pl-3 text-base/6 italic text-gray-600" data-v-b82c91d0>${ssrInterpolate(item.description)}</p><p class="font-mono text-xs pl-3 pt-2 text-gray-500" data-v-b82c91d0>`);
          _push(ssrRenderComponent(_component_Icon, {
      ...
      if (unref(showAs) === "grid") {
        _push(`<section class="mt-6 grid grid-cols-1 md:grid-cols-3 gap-x-10 gap-y-6 items-start" data-v-b82c91d0><!--[-->`);
        ssrRenderList(unref(pagedItems), (item) => {
          _push(`<div class="mb-4 cursor-pointer group" data-v-b82c91d0><div class="border-t border-gray-200 aspect-2/3 flex flex-col justify-center mb-2" data-v-b82c91d0><img${ssrRenderAttr("src", `https://archive.org/services/img/${item.identifier}`)} alt="item.shortTitle" class="p-3 w-full h-auto group-hover:scale-105 transition-transform duration-300" data-v-b82c91d0></div><div data-v-b82c91d0><p class="text-xs italic text-gray-500" data-v-b82c91d0>${ssrInterpolate(item.year)} - ${ssrInterpolate(item.author)}</p><h2 class="${ssrRenderClass([unref(selectedItem) === item.identifier ? "text-rosso-500" : "", "text-sm/5 mb-2 mt-1 text-gray-900 font-semibold group-hover:text-rosso-500 transition-colors duration-300"])}" data-v-b82c91d0>${ssrInterpolate(item.shortTitle)}</h2></div></div>`);
        });
        _push(`<!--]--></section>`);
      } else {
        _push(`<!---->`);
      ...
      if (unref(showAs) === "compact") {
        _push(`<section class="mt-8" data-v-b82c91d0><!--[-->`);
        ssrRenderList(unref(pagedItems), (item) => {
          _push(`<div class="pb-4 cursor-pointer group" data-v-b82c91d0><p class="text-xs italic text-gray-500" data-v-b82c91d0>${ssrInterpolate(item.year)} - ${ssrInterpolate(item.author)}</p><h2 class="${ssrRenderClass([unref(selectedItem) === item.identifier ? "text-rosso-500" : "", "text-sm/5 pl-2 text-gray-900 font-semibold group-hover:text-rosso-500 transition-colors duration-300"])}" data-v-b82c91d0>${ssrInterpolate(item.shortTitle)}</h2></div>`);
        });
        _push(`<!--]--></section>`);
      } else {
        _push(`<!---->`);
      ...
      _push(`</div><div data-v-b82c91d0></div></div><!--]-->`);
    };
  }
});
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-b82c91d0"]]);

export { index as default };
//# sourceMappingURL=index-Cm2ERioE.mjs.map
