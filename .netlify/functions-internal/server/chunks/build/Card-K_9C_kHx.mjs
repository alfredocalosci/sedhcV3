    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (!!__props.to && target.value === "_blank") {
        _push(ssrRenderComponent(_sfc_main$2, {
          ...
          class: ui.value.externalIcon({ class: unref(uiProp)?.externalIcon })
        }, null, _parent));
      } else {
        _push(`<!---->`);
      }
      if (__props.title || !!slots.title) {
        _push(`<p class="${ssrRenderClass(ui.value.title({ class: unref(uiProp)?.title }))}">`);
      ...
      if (!!slots.default) {
        _push(`<div class="${ssrRenderClass(ui.value.description({ class: unref(uiProp)?.description }))}">`);
...
//# sourceMappingURL=Card-K_9C_kHx.mjs.map
