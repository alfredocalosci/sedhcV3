...
import _sfc_main$2 from './CodeIcon-BPQCjBrp.mjs';
        ...
        default: withCtx(({ items: items2, level }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            ssrRenderList(items2, (item, index) => {
              _push2(`<li role="presentation" class="${ssrRenderClass(level > 1 ? ui.value.itemWithChildren({ class: unref(uiProp)?.itemWithChildren }) : ui.value.item({ class: unref(uiProp)?.item }))}"${_scopeId}>`);
              _push2(ssrRenderComponent(unref(TreeItem), {
                ...
                default: withCtx(({ isExpanded, isSelected }, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<button type="button" class="${ssrRenderClass(ui.value.link({ class: unref(uiProp)?.link, active: isSelected }))}"${_scopeId2}>`);
                    if (item.children?.length) {
                      _push3(ssrRenderComponent(_sfc_main$1, {
                        name: isExpanded ? unref(appConfig).ui.icons.folderOpen : unref(appConfig).ui.icons.folder,
                        class: ui.value.linkLeadingIcon({ class: unref(uiProp)?.linkLeadingIcon })
                    ...
                    _push3(`<span class="${ssrRenderClass(ui.value.linkLabel({ class: unref(uiProp)?.linkLabel }))}"${_scopeId2}>${ssrInterpolate(item.label)}</span>`);
                    if (item.children?.length) {
                      _push3(`<span class="${ssrRenderClass(ui.value.linkTrailing({ class: unref(uiProp)?.linkTrailing }))}"${_scopeId2}>`);
                      _push3(ssrRenderComponent(_sfc_main$1, {
                        name: unref(appConfig).ui.icons.chevronDown,
                        class: ui.value.linkTrailingIcon({ class: unref(uiProp)?.linkTrailingIcon })
                      }, null, _parent3, _scopeId2));
                      _push3(`</span>`);
                    } else {
                      _push3(`<!---->`);
                    ...
                    if (item.children?.length && isExpanded) {
                      _push3(`<ul role="group" class="${ssrRenderClass(ui.value.listWithChildren({ class: unref(uiProp)?.listWithChildren }))}"${_scopeId2}>`);
                    ...
                    return [
                      createVNode("button", {
                        type: "button",
                        class: ui.value.link({ class: unref(uiProp)?.link, active: isSelected })
                      }, [
                        ...
                        createVNode("span", {
                          class: ui.value.linkLabel({ class: unref(uiProp)?.linkLabel })
                        }, toDisplayString(item.label), 3),
                        item.children?.length ? (openBlock(), createBlock("span", {
                          key: 2,
                          class: ui.value.linkTrailing({ class: unref(uiProp)?.linkTrailing })
                        }, [
                      ...
                      item.children?.length && isExpanded ? (openBlock(), createBlock("ul", {
                        key: 0,
                        role: "group",
                        class: ui.value.listWithChildren({ class: unref(uiProp)?.listWithChildren })
                      }, [
            ...
            return [
              (openBlock(true), createBlock(Fragment, null, renderList(items2, (item, index) => {
                return openBlock(), createBlock("li", {
                  key: `${level}-${index}`,
                  role: "presentation",
                  class: level > 1 ? ui.value.itemWithChildren({ class: unref(uiProp)?.itemWithChildren }) : ui.value.item({ class: unref(uiProp)?.item })
                }, [
...
//# sourceMappingURL=CodeTree-DF3V64ZQ.mjs.map
