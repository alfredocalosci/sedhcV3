import { inject, computed, toValue, ref, watch, createVNode, resolveDynamicComponent, unref, mergeProps, withCtx, renderSlot, openBlock, createBlock, toDisplayString, provide, useModel, createTextVNode, createCommentVNode, mergeModels, defineComponent, useSSRContext } from 'vue';
...
const _sfc_main = /* @__PURE__ */ Object.assign({ inheritAttrs: false }, {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ssrRenderVNode(_push, createVNode(resolveDynamicComponent(unref(props).chip ? _sfc_main$1 : unref(Primitive)), mergeProps({
        as: as.value.root
              ...
              _push2(ssrRenderComponent(unref(Slot), _ctx.$attrs, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    ...
                    return [
                      renderSlot(_ctx.$slots, "default", {}, () => [
                        unref(props).icon ? (openBlock(), createBlock(_sfc_main$2, {
                          key: 0,
                          name: unref(props).icon,
                          "data-slot": "icon",
                          class: ui.value.icon({ class: unref(props).ui?.icon })
...
//# sourceMappingURL=Avatar-CsbOpQ4H.mjs.map
