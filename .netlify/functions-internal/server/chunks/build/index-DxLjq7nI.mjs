...
import { q as queryCollection, a as __nuxt_component_2, _ as __nuxt_component_0$1 } from './client-C-dpBcZ8.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "sedhc_grid" }, _attrs))} data-v-8ff1bb56><div class="bg-chiaro-50" data-v-8ff1bb56><aside class="bg-amber-400 hover:bg-chiaro-50 transition-colors duration-300 border-b border-white" data-v-8ff1bb56>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<img${ssrRenderAttr("src", _imports_0)} alt="sedhc" class="h-16 w-auto mt-2 mix-blend-multiply bg-white" data-v-8ff1bb56${_scopeId}><p class="text-sm/5 pt-2" data-v-8ff1bb56${_scopeId}>Sociedad Española de Historia de la Construcción</p>`);
          } else {
            return [
              createVNode("img", {
                src: _imports_0,
      ...
      _push(`</aside><article class="mt-10 px-10 text-xs italic quote pb-8" data-v-8ff1bb56><p data-v-8ff1bb56>Los hombres … teniendo por naturaleza, a diferencia de los otros animales, el no caminar inclinados a la tierra, sino rectos y elevados para ver la magnificencia del cielo y astros; como también, hallándose aptos con sus manos y articulaciones para tratar fácilmente cuanto querían, empezaron unos a disponer sus techados de ramas. </p><p data-v-8ff1bb56>Otros a cavar cuevas a la raíz de los montes. Algunos imitando los nidos de las golondrinas y su estructura, con barro y lodo hicieron donde guarecerse.</p><p data-v-8ff1bb56>Otros finalmente, que observaban estos abrigos, adelantando un poco mas sus invenciones, iban de día en día erigiendo menos mal arregladas chozas: así, que siendo aquellos hombres de imitadora y dócil naturaleza, gloriándose cada día de sus invenciones, se enseñaban unos a otros las nuevas formas de las casas que levantaban; y ejercitándose los ingenios en estas emulaciones, las iban de grado en grado mejorando de gusto.</p><p class="mt-6 pl-4" data-v-8ff1bb56>Vitruvio II, I,<br data-v-8ff1bb56>“Del principio de los edificios”<br data-v-8ff1bb56> (Texto: Ortiz y Sanz 1787)</p></article></div><div class="main_content" data-v-8ff1bb56>`);
      _push(ssrRenderComponent(_component_GlobalHeaderAlt, null, null, _parent));
      _push(`<nav class="hidden md:block mb-16 z-5 md:sticky top-0 bg-white pb-3 pt-2" data-v-8ff1bb56><ul class="flex items-center justify-end gap-3 font-mono uppercase text-xs text-gray-500" data-v-8ff1bb56><li class="${ssrRenderClass({ "text-black font-bold": activeSection.value === "finalidades" })}" data-v-8ff1bb56><a href="#finalidades" data-v-8ff1bb56>finalidades</a></li><li class="${ssrRenderClass({ "text-black  font-bold": activeSection.value === "junta_directiva" })}" data-v-8ff1bb56><a href="#junta_directiva" data-v-8ff1bb56>junta directiva</a></li><li class="${ssrRenderClass({ "text-black  font-bold": activeSection.value === "miembros" })}" data-v-8ff1bb56><a href="#miembros" data-v-8ff1bb56>miembros</a></li><li class="${ssrRenderClass({ "text-black  font-bold": activeSection.value === "estatutos" })}" data-v-8ff1bb56><a href="#estatutos" data-v-8ff1bb56>estatutos</a></li><li class="${ssrRenderClass({ "text-black  font-bold": activeSection.value === "entidades" })}" data-v-8ff1bb56><a href="#entidades" data-v-8ff1bb56>otras sociedades</a></li></ul></nav><section id="finalidades" class="mt-32 mb-16 step" data-v-8ff1bb56>`);
      if (introText.value) {
        _push(ssrRenderComponent(_component_ContentRenderer, {
      ...
      _push(`<img${ssrRenderAttr("src", _imports_1)} alt="eswn" class="my-6" data-v-8ff1bb56></section><section id="junta_directiva" class="step mb-16" data-v-8ff1bb56><div class="border-b border-dashed flex items-center justify-between mt-12" data-v-8ff1bb56><p class="font-mono uppercase text-sm font-semibold pb-1" data-v-8ff1bb56>junta directiva</p></div><div class="colums-1 md:columns-2 gap-x-8 mt-6" data-v-8ff1bb56>`);
      if (cargosText.value) {
        _push(ssrRenderComponent(_component_ContentRenderer, {
      ...
      _push(`</div></section><section id="miembros" class="step mb-16" data-v-8ff1bb56><div class="border-b border-dashed flex items-center justify-between mt-12" data-v-8ff1bb56><p class="font-mono uppercase text-sm font-semibold pb-1" data-v-8ff1bb56>miembros</p></div>`);
      ...
      _push(`</section><section id="estatutos" class="step mb-16" data-v-8ff1bb56><div class="border-b border-dashed flex items-center justify-between mt-12" data-v-8ff1bb56><p class="font-mono uppercase text-sm font-semibold pb-1" data-v-8ff1bb56>estatutos</p></div>`);
      ...
      _push(`</section><section id="entidades" class="step" data-v-8ff1bb56>`);
      ...
      _push(`</div><div data-v-8ff1bb56></div></div>`);
    };
  }
});
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-8ff1bb56"]]);

export { index as default };
//# sourceMappingURL=index-DxLjq7nI.mjs.map
