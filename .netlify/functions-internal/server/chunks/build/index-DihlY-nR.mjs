...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "sedhc_grid" }, _attrs))} data-v-8e307d26><aside class="w-full bg-neutro-500 flex flex-col" data-v-8e307d26>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<img${ssrRenderAttr("src", _imports_0)} alt="sedhc" class="h-16 w-auto mt-2 mix-blend-screen bg-black" data-v-8e307d26${_scopeId}><p class="text-sm/5 pt-2" data-v-8e307d26${_scopeId}>Sociedad Española de Historia de la Construcción</p>`);
          } else {
            return [
              createVNode("img", {
                src: _imports_0,
      ...
      _push(`<section class="p-8 text-sm text-gray-800 italic hidden lg:block" data-v-8e307d26>`);
      if (unref(sideText)) {
      ...
      _push(`</section><div class="hidden lg:block" data-v-8e307d26>`);
      _push(ssrRenderComponent(_component_rrss, null, null, _parent));
      _push(`</div></aside><div class="main_content bg-white" data-v-8e307d26>`);
      _push(ssrRenderComponent(_component_GlobalHeaderAlt, null, null, _parent));
      _push(`<div class="grid grid-cols-2 md:grid-cols-3 gap-x-7 gap-y-4 text-xs mt-6 border-b border-gray-400 border-dashed pb-6 ml-1" data-v-8e307d26><!--[-->`);
      ssrRenderList(unref(categorias), (cat, index2) => {
        _push(`<div class="cursor-pointer" data-v-8e307d26><p class="group" data-v-8e307d26><strong " class="${ssrRenderClass([{
        ...
        }, "font-bold text-xs -ml-1 transition-colors duration-300 group-hover:text-orange-600"])}" data-v-8e307d26>${ssrInterpolate(cat.nombre)}: </strong><br data-v-8e307d26><span class="${ssrRenderClass([{
          "text-gray-400": unref(selectedSubject) !== cat.slug && unref(selectedSubject) !== null,
          "text-gray-600 ": unref(selectedSubject) === cat.slug,
          "text-gray-600": unref(selectedSubject) === null
        }, "italic transition-colors duration-300"])}" data-v-8e307d26>${ssrInterpolate(cat.desc)}</span></p></div>`);
      });
      _push(`<!--]--></div><div class="flex items-center justify-between gap-4 mb-16 z-5 md:sticky top-0 bg-white py-3" data-v-8e307d26><p class="font-mono text-xs text-gray-500" data-v-8e307d26>mostrando <span class="text-scuro-900 font-semibold" data-v-8e307d26>${ssrInterpolate(unref(filteredNoticias).length)}</span> noticias de <span class="text-scuro-900 font-semibold" data-v-8e307d26>${ssrInterpolate(unref(noticias)?.length)}</span></p><div class="relative" data-v-8e307d26><input type="search" id="site-search" name="q"${ssrRenderAttr("value", unref(searchString))} placeholder="Buscar …" class="font-mono text-xs border-b border-gray-300 focus:border-rosso-500 focus:ring-0 focus:outline-none transition-colors duration-200 w-full mb-4 md:mb-0 pl-6 pb-1.5" data-v-8e307d26>`);
      ...
      _push(`</div></div><div class="mt-8 max-w-5/6" data-v-8e307d26><!--[-->`);
      ssrRenderList(unref(noticiasDestacadas), (noticia) => {
        _push(`<div class="mb-4 pb-4" data-v-8e307d26>`);
        _push(ssrRenderComponent(_component_NuxtLink, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<p class="text-sm italic text-gray-500" data-v-8e307d26${_scopeId}>${ssrInterpolate(("formatSpanishDate" in _ctx ? _ctx.formatSpanishDate : unref(formatSpanishDate))(noticia.date))}</p><h2 class="text-2xl/7 my-3 text-gray-900 font-semibold group-hover:text-rosso-500 transition-colors duration-300" data-v-8e307d26${_scopeId}>${ssrInterpolate(noticia.title)}</h2><p class="pl-3 text-base/6 italic text-gray-600" data-v-8e307d26${_scopeId}>${ssrInterpolate(noticia.description)}</p>`);
            } else {
              return [
      ...
      _push(`<!--]--></div><div class="mt-12" data-v-8e307d26><!--[-->`);
      ssrRenderList(Object.keys(unref(noticiasCompactasByYears)).sort((a, b) => Number(b) - Number(a)), (year) => {
        _push(`<div class="mb-12" data-v-8e307d26><h4 class="text-xs font-mono w-full border-b border-dashed border-gray-300 text-gray-500 pb-2 text-right mb-6" data-v-8e307d26>${ssrInterpolate(year)}</h4><!--[-->`);
        ssrRenderList(unref(noticiasCompactasByYears)[year], (noticia) => {
          _push(`<div class="mb-3 pb-3" data-v-8e307d26>`);
          _push(ssrRenderComponent(_component_NuxtLink, {
            to: `/noticias/${noticia.slug}`,
            class: "group"
          }, {
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`<p class="text-xs italic text-gray-500" data-v-8e307d26${_scopeId}>${ssrInterpolate(("formatSpanishDate" in _ctx ? _ctx.formatSpanishDate : unref(formatSpanishDate))(noticia.date))}</p><h3 class="text-sm/5 pl-3 my-1 text-gray-900 font-semibold group-hover:text-rosso-500 transition-colors duration-300" data-v-8e307d26${_scopeId}>${ssrInterpolate(noticia.title)}</h3>`);
              } else {
                return [
      ...
      _push(`</div><div data-v-8e307d26></div></div>`);
    };
  }
});
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-8e307d26"]]);

export { index as default };
//# sourceMappingURL=index-DihlY-nR.mjs.map
