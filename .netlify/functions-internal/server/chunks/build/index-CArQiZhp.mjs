      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<p class="text-lg font-semibold"${_scopeId}>acceso al gestor de contenidos <span class="text-orange-500 text-sm pl-2"${_scopeId}>→</span></p>`);
          } else {
            return [
              ...
              createVNode("p", { class: "text-lg font-semibold" }, [
                createTextVNode("acceso al gestor de contenidos "),
                createVNode("span", { class: "text-orange-500 text-sm pl-2" }, "→")
              ])
            ];
          }
        }),
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<p class="text-lg font-semibold"${_scopeId}>GitHub <span class="text-orange-500 text-sm pl-2"${_scopeId}>→</span></p>`);
          } else {
            return [
              createVNode(_component_UIcon, {
                name: "mdi:github",
...
//# sourceMappingURL=index-CArQiZhp.mjs.map
