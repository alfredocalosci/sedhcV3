...
import _sfc_main$1 from './CodeIcon-BPQCjBrp.mjs';
                    ...
                    _push3(ssrRenderComponent(unref(TabsTrigger), {
                      ...
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          ...
                          _push4(`<span class="${ssrRenderClass(ui.value.triggerLabel({ class: unref(uiProp)?.triggerLabel }))}"${_scopeId3}>${ssrInterpolate(item.label)}</span>`);
                        } else {
                          return [
...
//# sourceMappingURL=CodeGroup-CtMZ-Ynl.mjs.map
