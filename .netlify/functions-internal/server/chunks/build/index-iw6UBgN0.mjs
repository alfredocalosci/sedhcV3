...
import { _ as _sfc_main$3 } from './Icon-DsBGEmrB.mjs';
...
import { u as useAsyncData, _ as __nuxt_component_3 } from './asyncData-CJgDaN-V.mjs';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_CustomUISidePanel, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<p class="font-semibold text-lg/6" data-v-228615a1${_scopeId}>${ssrInterpolate(unref(selectedTitle))}</p><p class="italic text-gray-300 pt-4 text-base" data-v-228615a1${_scopeId}>${ssrInterpolate(unref(selectedCongreso)?.lugar)}</p><p class="italic text-gray-300 pt-1 text-xs" data-v-228615a1${_scopeId}>${ssrInterpolate(unref(selectedCongreso)?.sede)}</p>`);
            if (unref(selectedCongreso)?.dateFrom) {
              _push2(`<p class="italic text-gray-300 pt-4 text-sm" data-v-228615a1${_scopeId}>${ssrInterpolate(formatDayMonth(unref(selectedCongreso).dateFrom))}`);
              if (unref(selectedCongreso)?.dateTo) {
                _push2(`<span data-v-228615a1${_scopeId}> - ${ssrInterpolate(formatDayMonthYear(unref(selectedCongreso).dateTo))}</span>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</p>`);
            ...
            _push2(`<div class="mt-6 pointer-events-auto border-t border-gray-600 pt-4" data-v-228615a1${_scopeId}>`);
            if (unref(selectedCongreso)?.url) {
              _push2(`<a${ssrRenderAttr("href", unref(selectedCongreso)?.url)} target="_blank" class="flex items-center gap-x-2 mb-4 group cursor-pointer pointer-events-auto" rel="noopener noreferrer" data-v-228615a1${_scopeId}>`);
              _push2(ssrRenderComponent(_component_UIcon, {
                name: "lucide:app-window-mac",
                style: { "color": "white" },
                size: "24"
              }, null, _parent2, _scopeId));
              _push2(`<span class="ml-2 text-xs italic text-white/70 group-hover:text-white transition-colors duration-300" data-v-228615a1${_scopeId}>${ssrInterpolate(("shortenUrl" in _ctx ? _ctx.shortenUrl : unref(shortenUrl))(unref(selectedCongreso)?.url, 30))}</span></a>`);
            } else {
              _push2(`<!---->`);
            }
            if (unref(selectedCongreso)?.actas) {
              _push2(`<div class="pt-4 border-t border-gray-600" data-v-228615a1${_scopeId}><p class="font-mono text-xs mb-4 text-gray-400" data-v-228615a1${_scopeId}>actas en archive.org:</p><!--[-->`);
              ssrRenderList(unref(selectedCongreso).actas, (acta) => {
                _push2(`<a${ssrRenderAttr("href", "https://archive.org/details/" + acta.identifier)} target="_blank" class="flex items-center gap-x-2 mb-2 group cursor-pointer pointer-events-auto" rel="noopener noreferrer" data-v-228615a1${_scopeId}>`);
                _push2(ssrRenderComponent(_component_UIcon, {
                  name: "lucide:book-open",
                  style: { "color": "white" },
                  size: "24"
                }, null, _parent2, _scopeId));
                _push2(`<span class="ml-2 text-sm italic text-white/70 group-hover:text-white transition-colors duration-300" data-v-228615a1${_scopeId}>${ssrInterpolate(acta.title)}</span></a>`);
              });
              _push2(`<!--]--></div>`);
            } else {
              _push2(`<!---->`);
            ...
            if (unref(selectedCongreso)?.image?.src && !unref(selectedCongreso)?.actas) {
              _push2(`<div class="mt-12 hidden lg:block" data-v-228615a1${_scopeId}><img${ssrRenderAttr("src", unref(selectedCongreso).image.src)}${ssrRenderAttr("alt", unref(selectedCongreso).image.alt)} class="w-full h-auto border border-gray-300 grayscale" data-v-228615a1${_scopeId}></div>`);
            } else {
              _push2(`<!---->`);
            }
            if (unref(selectedCongreso)?.actas) {
              _push2(`<div class="mt-6 hidden lg:block" data-v-228615a1${_scopeId}><div class="grid grid-cols-3 gap-4" data-v-228615a1${_scopeId}><!--[-->`);
              ssrRenderList(unref(selectedCongreso).actas, (acta) => {
                _push2(`<a${ssrRenderAttr("href", "https://archive.org/details/" + acta.identifier)} target="_blank" class="flex items-center gap-x-2 mb-2 group cursor-pointer pointer-events-auto" rel="noopener noreferrer" data-v-228615a1${_scopeId}><img${ssrRenderAttr("src", "https://archive.org/services/img/" + acta.identifier)}${ssrRenderAttr("alt", acta.title)} class="w-full h-auto border border-gray-300 grayscale group-hover:grayscale-0 transition-all duration-300" data-v-228615a1${_scopeId}></a>`);
              });
              _push2(`<!--]--></div></div>`);
            } else {
              _push2(`<!---->`);
      ...
      _push(`<div class="sedhc_grid" data-v-228615a1><aside class="w-full h-full bg-revista-500 flex flex-col pb-8" data-v-228615a1>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<img${ssrRenderAttr("src", _imports_0)} alt="sedhc" class="h-16 w-auto mt-2 mix-blend-screen bg-black" data-v-228615a1${_scopeId}><p class="text-sm/5 pt-2" data-v-228615a1${_scopeId}>Sociedad Española de Historia de la Construcción</p>`);
          } else {
            return [
              createVNode("img", {
                src: _imports_0,
      ...
      _push(`<article class="px-8 mt-2 lg:mt-12 italic text-gray-100" data-v-228615a1>`);
      if (unref(sideText)) {
      ...
      _push(`</article></aside><div class="main_content bg-white" data-v-228615a1>`);
      _push(ssrRenderComponent(_component_GlobalHeaderAlt, null, null, _parent));
      _push(`<section class="mt-32" data-v-228615a1>`);
      if (unref(introText)) {
        _push(ssrRenderComponent(_component_ContentRenderer, {
      ...
      _push(`</section><section class="mt-24" data-v-228615a1><p class="pt-6 font-mono uppercase text-sm border-b border-dashed font-semibold pb-1 mt-18 mb-8" data-v-228615a1>Congresos de Historia de la construcción:</p>`);
      ...
      if (unref(lugaresData).length) {
        _push(`<section class="mb-12 mt-24" data-v-228615a1>`);
      ...
      _push(`</div><div data-v-228615a1></div></div><!--]-->`);
    };
  }
});
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-228615a1"]]);

export { index as default };
//# sourceMappingURL=index-iw6UBgN0.mjs.map
