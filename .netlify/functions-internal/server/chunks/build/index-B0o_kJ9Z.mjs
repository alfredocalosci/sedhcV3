...
import { _ as _sfc_main$2 } from './Icon-D0CT7Pv4.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "sedhc_grid" }, _attrs))} data-v-b9775d89><div class="bg-revista-500 pb-6" data-v-b9775d89><aside data-v-b9775d89>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<img${ssrRenderAttr("src", _imports_0)} alt="sedhc" class="h-16 w-auto mt-2 mix-blend-screen bg-black" data-v-b9775d89${_scopeId}><p class="text-sm/5 pt-2" data-v-b9775d89${_scopeId}>Sociedad Española de Historia de la Construcción</p>`);
          } else {
            return [
              createVNode("img", {
                src: _imports_0,
      ...
      _push(`<div class="px-8 mt-8 lg:mt-20 italic text-gray-100" data-v-b9775d89>`);
      if (unref(sideText)) {
      ...
      _push(`<div class="mt-6 pointer-events-auto border-t border-gray-400 pt-6" data-v-b9775d89><a href="#" target="_blank" class="flex items-center gap-x-2 mb-2 group cursor-pointer pointer-events-auto" rel="noopener noreferrer" data-v-b9775d89>`);
      _push(ssrRenderComponent(_component_UIcon, {
        name: "lucide:app-window-mac",
        style: { "color": "white" },
        size: "24"
      }, null, _parent));
      _push(`<span class="ml-2 text-xs italic text-white/70 group-hover:text-white transition-colors duration-300" data-v-b9775d89>${ssrInterpolate(("shortenUrl" in _ctx ? _ctx.shortenUrl : unref(shortenUrl))("https://polipapers.upv.es/index.php/HC/index", 30))}</span></a></div></div></aside></div><div class="main_content bg-white" data-v-b9775d89>`);
      _push(ssrRenderComponent(_component_GlobalHeaderAlt, null, null, _parent));
      _push(`<section id="intro" class="mt-32 mb-16" data-v-b9775d89>`);
      if (unref(introText)) {
        _push(ssrRenderComponent(_component_ContentRenderer, {
      ...
      _push(`</section><section id="volumenes" class="mb-16" data-v-b9775d89><p class="pt-6 font-mono uppercase text-sm border-b border-dashed font-semibold pb-1 mb-8" data-v-b9775d89>Volúmenes publicados:</p>`);
      _push(ssrRenderComponent(_component_revistas, null, null, _parent));
      _push(`</section><section class="mb-16" data-v-b9775d89>`);
      if (unref(mainText)) {
        _push(ssrRenderComponent(_component_ContentRenderer, {
      ...
      _push(`</section><section class="mb-16" data-v-b9775d89><p class="pt-6 font-mono uppercase text-sm border-b border-dashed font-semibold pb-1 mb-8" data-v-b9775d89>Redacción:</p>`);
      if (unref(cargosText)) {
        _push(ssrRenderComponent(_component_ContentRenderer, {
      ...
      _push(`</div><div data-v-b9775d89></div></div>`);
    };
  }
});
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-b9775d89"]]);

export { index as default };
//# sourceMappingURL=index-B0o_kJ9Z.mjs.map
