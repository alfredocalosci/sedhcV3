...
import { u as useComponentUI, t as tv, a as transformUI } from './tv-BpNzT_zm.mjs';
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$1, mergeProps({
        ...
        default: withCtx(({ open }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<button class="${ssrRenderClass(ui.value.trigger({ class: unref(uiProp)?.trigger }))}"${_scopeId}>`);
            _push2(ssrRenderComponent(_sfc_main$2, {
              name: __props.icon || unref(appConfig).ui.icons.chevronDown,
              class: ui.value.triggerIcon({ class: unref(uiProp)?.triggerIcon })
            }, null, _parent2, _scopeId));
            _push2(`<span class="${ssrRenderClass(ui.value.triggerLabel({ class: unref(uiProp)?.triggerLabel }))}"${_scopeId}>${ssrInterpolate(open ? props.closeText || unref(t)("prose.collapsible.closeText") : props.openText || unref(t)("prose.collapsible.openText"))} ${ssrInterpolate(props.name || unref(t)("prose.collapsible.name"))}</span></button>`);
          } else {
            return [
              createVNode("button", {
                ...
                createVNode("span", {
                  class: ui.value.triggerLabel({ class: unref(uiProp)?.triggerLabel })
...
//# sourceMappingURL=Collapsible-DgdoQKeX.mjs.map
