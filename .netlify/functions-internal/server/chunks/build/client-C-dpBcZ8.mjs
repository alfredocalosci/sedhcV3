import { computed, toRaw, mergeProps, unref, withCtx, createTextVNode, resolveComponent, defineAsyncComponent, defineComponent, h, getCurrentInstance, reactive, watch, Text, Comment, useSSRContext } from 'vue';
import { ssrRenderComponent, ssrRenderSlot, ssrRenderAttrs } from 'vue/server-renderer';
import { z as pascalCase, A as kebabCase, B as withoutTrailingSlash, f as destr, C as getRequestHeaders } from '../nitro/nitro.mjs';
import { find, html } from 'property-information';
import { f as flatUnwrap, n as nodeTextContent } from './node-CIB8iVlG.mjs';
import { toHast } from 'minimark/hast';
import { t as tryUseNuxtApp, _ as _export_sfc, c as useRuntimeConfig } from './server.mjs';
...
export { __nuxt_component_0 as _, __nuxt_component_2 as a, queryCollection as q };
//# sourceMappingURL=client-C-dpBcZ8.mjs.map
